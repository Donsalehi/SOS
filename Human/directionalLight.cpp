...
void walkZ(float degree, string direction) {
	...
	//rotate hands
	Worlds[6] = PositionFinder(3.0f, 0, new float[] {-2.85f - right_left_move, -2.5f + up_down_move,
		0.0f - forward_backward_move}, 3.14 / 2, rotation_degree, "x", "x");
	Worlds[7] = PositionFinder(3.0f, 0, new float[] {+2.85f - right_left_move, -2.5f + up_down_move,
		0.0f - forward_backward_move}, 3.14 / 2, -rotation_degree, "x", "x");
	...
	//rotate legs
	Worlds[10] = PositionFinder(3.0f, 0, new float[] {-1.2f - right_left_move, -5.8f + up_down_move,
		0.0f - forward_backward_move}, 3.14 / 2, rotation_degree, "x", "x");
	Worlds[11] = PositionFinder(3.0f, 0, new float[] {1.2f - right_left_move, -5.8f + up_down_move,
		0.0f - forward_backward_move}, 3.14 / 2, -rotation_degree, "x","x");
...
bool Setup()
{
	...
	D3DXCreateBox(Device, 2.6, 4.1, 1.3, &Objects[0], 0); //body
	...
	D3DXCreateBox(Device, 1.5f, 1.0f, 1.3f, &Objects[8], 0); //left shoulder
	D3DXCreateBox(Device, 1.5f, 1.0f, 1.3f, &Objects[9], 0); //right shoulder
